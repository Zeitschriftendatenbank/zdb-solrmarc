...
set PROPERTIES_FILE="vufind_titel_config.properties"
set ERROR_LOG="import\error-log"
set IMPORT_LOG="import\import-log"
set SOLR_JAR_DEF="-Dsolrmarc.solr.war.path=K:\IIE\xampp\htdocs\vufind\solr\jetty\webapps\solr.war"
