...
public abstract class MarcHandler {
	...
	public void init(String args[])
	{
        ...
        if(args.length > 0)
        {
            for (String arg : args)
            {
                ...
                {
                	logger.info("ConfigProperties: " + arg);
	...
	{       
        ...
        logger.info("LoadReader passed perfect");
        return;
	}
	...
	public void loadIndexer(String indexerName, String indexerProps) 
	{
	    ...
	    try
	    {
	    	logger.info("Class found for Name: " + indexerName);
	    ...
	    {
	    	logger.error("Construction of " + indexerName + " failed");
	        e.printStackTrace();
